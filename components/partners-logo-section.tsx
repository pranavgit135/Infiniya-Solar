...
export default function PartnerLogosSection({ data }: { data: any }) {
  ...
  const partnerLogos: CustomerLogo[] =data.partnerLogoSectionCollection.items
  const partnerLogo: CustomerLogo[] = [
  ...
  const uniqueLogos = partnerLogos.slice(0, 6)
      ...
      <div className="container mx-auto relative">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
            ...
            <span className="text-[#f47920] text-3xl xl:text-4xl">Partner Base</span>
          </h2>
          ...
          <p className="text-gray-600 max-w-2xl md:max-w-4xl mx-auto text-base xl:text-lg">
            We&apos;ve served number of partners in 18 states in India across variety of industries, helping them cut down on
